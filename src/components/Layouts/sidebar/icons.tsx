...
export function UploadIcon(props: PropsType) {
  return (
    <svg width={24} height={24} viewBox="0 0 24 24" fill="none" {...props}>
      <path
        d="M12 2.25a.75.75 0 01.75.75v11.25a.75.75 0 01-1.5 0V3a.75.75 0 01.75-.75z"
        fill="currentColor"
      />
      <path
        d="M7.28 7.72a.75.75 0 010 1.06l-4.5 4.5a.75.75 0 01-1.06-1.06l4.5-4.5a.75.75 0 011.06 0zM16.72 7.72a.75.75 0 011.06 0l4.5 4.5a.75.75 0 11-1.06 1.06l-4.5-4.5a.75.75 0 010-1.06z"
        fill="currentColor"
      />
      <path
        d="M2.25 18a.75.75 0 01.75-.75h18a.75.75 0 010 1.5H3a.75.75 0 01-.75-.75z"
        fill="currentColor"
      />
    </svg>
  );
...
export function CasesIcon(props: PropsType) {
  return (
    <svg width={24} height={24} viewBox="0 0 24 24" fill="none" {...props}>
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M7.757 2.879a3 3 0 012.122-.879h4.242a3 3 0 012.122.879L18.707 4.5H20a2 2 0 012 2v11a2 2 0 01-2 2H4a2 2 0 01-2-2V6.5a2 2 0 012-2h1.293l1.464-1.621zM9.879 3.5a1.5 1.5 0 00-1.06.44L7.464 5.5H4V18h16V5.5h-3.464l-1.354-1.56a1.5 1.5 0 00-1.061-.44H9.878z"
        fill="currentColor"
      />
      <path
        d="M9 11.25a2.75 2.75 0 115.5 0 2.75 2.75 0 01-5.5 0zM11.75 6.5a.75.75 0 00-.75.75v1a.75.75 0 001.5 0v-1a.75.75 0 00-.75-.75z"
        fill="currentColor"
      />
    </svg>
  );
...
export function PoliciesIcon(props: PropsType) {
  return (
    <svg width={24} height={24} viewBox="0 0 24 24" fill="none" {...props}>
      <path
        d="M5 4a2 2 0 012-2h10a2 2 0 012 2v16l-5.5-3-5.5 3V4z"
        stroke="currentColor"
        strokeWidth={1.5}
        strokeLinecap="round"
...
export function SecurityIcon(props: PropsType) {
  return (
    <svg width={24} height={24} viewBox="0 0 24 24" fill="none" {...props}>
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M12 1.25a.75.75 0 01.673.418l3.5 7.5a.75.75 0 01-.246.93l-2.927 2.027v7.826a.75.75 0 01-1.168.624l-5-3a.75.75 0 01-.332-.624v-7.826L3.073 9.598a.75.75 0 01-.246-.93l3.5-7.5A.75.75 0 017 1.25h5zM5.234 9.08L7.5 10.5v7.32l3.5 2.1v-9.42L5.234 9.08zM8.266 2.75L5.834 8.173l4.916 3.407V2.75H8.266zm7.468 0H12.25v8.83l4.916-3.407L15.734 2.75z"
        fill="currentColor"
      />
    </svg>
  );
...
export function SparklesIcon(props: PropsType) {
  return (
    <svg width={24} height={24} viewBox="0 0 24 24" fill="none" {...props}>
      <path
      ...
      />
      <path
        d="M19 15L19.59 17.59L22 18.18L19.59 18.77L19 21.36L18.41 18.77L16 18.18L18.41 17.59L19 15Z"
        fill="currentColor"
      />
      <path
        d="M5 18L5.45 19.45L6.9 19.9L5.45 20.35L5 21.8L4.55 20.35L3.1 19.9L4.55 19.45L5 18Z"
        fill="currentColor"
      />
    </svg>
  );
  ...
  return (
    <svg width={24} height={24} viewBox="0 0 24 24" fill="none" {...props}>
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M12 2.25c-5.385 0-9.75 4.365-9.75 9.75s4.365 9.75 9.75 9.75 9.75-4.365 9.75-9.75S17.385 2.25 12 2.25zM9.424 8.825a3.75 3.75 0 116.303 4.25 1.5 1.5 0 00-1.5 2.598 1.5 1.5 0 01-3 0v-.75a.75.75 0 00-1.5 0v.75a3 3 0 005.196 2.123 3.75 3.75 0 10-3.499-6.972V9.75a.75.75 0 00-1.5 0v-.75c0-.413.336-.75.75-.75h.75a.75.75 0 000-1.5h-.75A2.25 2.25 0 009.424 8.825zM13.5 7.5a1.5 1.5 0 11-3 0 1.5 1.5 0 013 0z"
        fill="currentColor"
      />
    </svg>
  );
